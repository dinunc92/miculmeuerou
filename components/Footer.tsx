      ...
      <div className="mx-auto max-w-6xl px-4 py-10 grid md:grid-cols-4 gap-8 text-sm">
        ...
        <div>
          ...
          <div className="mt-4 flex items-center gap-3">
            {/* Facebook */}
            <a className="link-strong rounded-full p-2" href="https://www.facebook.com/miculmeuerou" target="_blank" rel="noreferrer" aria-label="Facebook">
            ...
            {/* WhatsApp */}
            <a className="link-strong rounded-full p-2" href="https://wa.me/40784052345" target="_blank" rel="noreferrer" aria-label="WhatsApp">
      ...
      <img src="/brands/odr.png" alt="ODR" className="h-8 w-auto" />
        ...
        <div>
          ...
          <ul className="space-y-1">
            ...
            <li><a className="link-strong" href="tel:+40784052345">+40784052345</a></li>
            <li><a className="link-strong" href="https://wa.me/40784052345" target="_blank" rel="noreferrer">WhatsApp</a></li>
          </ul>
        </div>
      </div>
